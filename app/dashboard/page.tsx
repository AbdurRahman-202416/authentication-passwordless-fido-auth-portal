      ...
      <div className="relative max-w-6xl mx-auto">
        <div className="flex justify-between items-center mb-8 pt-4">
          ...
          <button
            ...
            className="bg-gray-700/50 hover:bg-gray-600/50 text-white px-4 py-2 rounded-lg transition-colors text-sm font-medium"
          >
            Logout
          </button>
        </div>
        ...
        <div className="bg-gray-800/50 backdrop-blur-xl rounded-3xl shadow-2xl border border-gray-700/50 p-8 mb-6">
          <div className="flex flex-col items-center text-center">
            ...
            <p className="text-gray-400 mb-4">
              You've successfully logged in with password + passkey authentication
            </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="bg-gray-800/50 backdrop-blur-xl rounded-2xl border border-gray-700/50 p-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="text-white font-semibold mb-2">Passkey Enabled</h3>
                <p className="text-sm text-gray-400">
        ...
        <div className="mt-6 bg-gray-800/50 backdrop-blur-xl rounded-2xl border border-gray-700/50 p-6">
          <h3 className="text-white font-semibold mb-4 text-lg">Authentication Flow</h3>
          <div className="space-y-3">
            ...
            <div className="flex items-center gap-3 text-sm">
              ...
              <p className="text-gray-300">System verifies password credentials</p>
            </div>
            <div className="flex items-center gap-3 text-sm">
              ...
              <p className="text-gray-300">User authenticates with biometric passkey</p>
            </div>
            <div className="flex items-center gap-3 text-sm">
              <div className="w-8 h-8 rounded-full bg-emerald-500/20 flex items-center justify-center text-emerald-400 font-semibold">4</div>
